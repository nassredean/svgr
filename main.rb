...
def create_combined_svg(elements, rows, columns)
...
if ARGV.length != 4
  puts "Usage: ruby combine_svgs.rb <source_directory> <output_file> <rows> <columns>"
  exit(1)
end
...
combined_svg = create_combined_svg(combined_elements, rows, columns)
